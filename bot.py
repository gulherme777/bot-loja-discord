    ...
    if d.get("status") == "paid" and d.get("order_nsu"):
        with webhook_lock:
            ...
            if len(pts) >= 3:
                ...
                # Lógica para extrair produto_id e variacao_nome do order_nsu
                # order_nsu pode ser \'produto_id_user_id_timestamp\' ou \'produto_id_variacao_nome_user_id_timestamp\'
                # Precisamos reconstruir o produto_id original e a variação, se houver.
                # O produto_id pode conter underscores, então precisamos verificar se o primeiro segmento é um produto_id válido.
